  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 md:py-32">
        <div className="text-center space-y-6 md:space-y-8">
          ...
          <h1 className="hero-title overflow-hidden">
            <span className="block text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extralight tracking-[0.15em] sm:tracking-[0.2em] text-white">
              EXCLUSIVE
            </span>
            <span className="block text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extralight tracking-[0.15em] sm:tracking-[0.2em] text-white/80 mt-2 sm:mt-4">
              PROPERTIES
            </span>
          </h1>

          {/* Subtítulo */}
          <p className="hero-subtitle text-lg sm:text-xl md:text-2xl text-white/60 font-light tracking-wider max-w-3xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-3xl mx-auto mt-8 sm:mt-12 md:mt-16 px-4">
            {[
              ...
              <div key={index} className="stat-item text-center">
                ...
                <div className="text-xs sm:text-sm tracking-[0.2em] text-white/60">{stat.label}</div>
              </div>
            ))}
          </div>
          ...
          <div className="cta-wrapper flex flex-col sm:flex-row justify-center sm:space-x-6 space-y-4 sm:space-y-0 mt-8 sm:mt-12 px-4">
            <button className="group relative px-6 sm:px-8 py-3 sm:py-4 overflow-hidden w-full sm:w-auto">
              ...
              <span className="relative z-10 text-sm tracking-[0.2em] text-white/80 group-hover:text-white transition-colors duration-300">
                VIEW PORTFOLIO
              </span>
            </button>
            <button className="group relative px-6 sm:px-8 py-3 sm:py-4 overflow-hidden w-full sm:w-auto">
      ...
      <div className="absolute bottom-8 sm:bottom-12 left-1/2 transform -translate-x-1/2 flex flex-col items-center">
        ...
        <span className="text-white/40 text-xs sm:text-sm tracking-[0.2em] mt-4">SCROLL</span>
      </div>
    </section>
  );
};
